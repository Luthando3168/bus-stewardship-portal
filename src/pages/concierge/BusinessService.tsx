...
import { Briefcase, Search, ChevronRight, Users, Building, FileText } from "lucide-react";
        ...
        <div className="relative rounded-xl overflow-hidden h-48 md:h-60 mb-6">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
            ...
            <p className="text-sm md:text-base max-w-md">
              Access expert business services to help your company thrive in today's competitive landscape
            </p>
          </div>
        </div>
