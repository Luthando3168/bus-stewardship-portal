        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="bg-lightgray rounded-lg p-6 mb-8">
              <p className="text-lg text-navyblue text-center italic">"I'm a taxi owner and now I am  parts of registered owners for a  franchise, a shop and a farm. LMCA handles everything  and reports to me while I focus on my taxi business!"</p>
            ...
            <div className="text-center">
              <Link to="/register" className="inline-block px-8 py-4 bg-gold text-white rounded-lg font-semibold hover:bg-lightgold transition-colors">
