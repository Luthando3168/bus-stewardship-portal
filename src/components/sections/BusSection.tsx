        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg p-6 mb-8 border-l-4 border-gold">
              <p className="text-lg text-navyblue text-center italic mb-2">
                "I'm a taxi owner and now I am parts of registered owners for a franchise, 
                a shop and a farm. LMCA handles everything and reports to me while I focus 
                on my taxi business!"
              </p>
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div 
                  key={index}
                  className="bg-white rounded-lg p-6 shadow-md border-l-4 border-gold hover:shadow-lg transition-shadow"
                >
            ...
            <div className="text-center mt-10">
              <Link 
                to="/register" 
                className="inline-flex items-center px-8 py-4 bg-gold text-white rounded-lg font-semibold hover:bg-lightgold transition-colors"
              >
