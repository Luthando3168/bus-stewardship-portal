      ...
      <div className="container max-w-[1400px] mx-auto px-4">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md text-center mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="space-y-2">
                ...
                <p className="text-gray-600">Simple online registration process with basic documents needed.</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600">Begin your ownership journey and save up just R500 monthly</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-navyblue text-white p-8 rounded-xl shadow-lg">
            ...
            <Link to="/impact-funds" className="inline-block px-8 py-4 bg-gold text-navyblue font-semibold rounded-lg hover:bg-lightgold transition-colors text-lg">
