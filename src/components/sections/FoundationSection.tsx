...
const FoundationSection = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-navyblue to-navyblue/90">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto bg-white/10 backdrop-blur-sm rounded-lg shadow-xl p-8 mb-10 border border-white/20">
          ...
          <div className="text-center">
            <Link 
              to="/foundation" 
              className="inline-flex items-center px-6 py-3 bg-gold text-navyblue rounded-lg font-semibold hover:bg-white transition-all duration-300 group"
            >
