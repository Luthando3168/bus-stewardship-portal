...
const Hero = () => (
  <section className="w-full min-h-[80vh] flex items-start justify-center bg-navyblue px-2 relative overflow-hidden">
    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col items-start justify-start py-12 relative z-10">
      {/* Text Content - matches the image layout */}
      <div className="flex-1 flex flex-col items-start text-left px-4 md:px-0 mb-8">
        <h1 className="font-montserrat font-extrabold text-4xl sm:text-5xl md:text-6xl tracking-tight text-white mb-2 leading-tight">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-8">
          <Link
            to="/contact"
            className="w-full sm:w-auto px-8 py-4 font-montserrat font-semibold text-lg rounded bg-gold text-navyblue shadow hover:bg-lightgold transition-colors hover-scale"
          >
            Get Started
          </Link>
        </div>
      ...
      {/* Image removed for mobile version to match the design in the image */}
