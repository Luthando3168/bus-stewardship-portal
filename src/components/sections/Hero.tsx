...
const Hero = () => (
  <section className="w-full min-h-[80vh] flex items-center justify-center bg-navyblue px-2 relative overflow-hidden">
    ...
    <div className="w-full max-w-6xl mx-auto flex items-center justify-center py-12 md:py-24 relative z-10">
      <div className="flex-1 flex flex-col items-center text-center max-w-3xl px-4 md:px-0">
