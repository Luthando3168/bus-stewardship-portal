...
const Hero = () => (
  <section className="w-full min-h-[70vh] flex items-center justify-center bg-navyblue px-4 py-8 md:py-12 relative overflow-hidden">
    ...
    <div className="container max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
      {/* Text Content */}
      <div className="w-full md:w-1/2 flex flex-col items-start text-left mb-8 md:mb-0 md:pr-8">
        <h1 className="font-montserrat font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-tight text-white mb-2 leading-tight">
          Managing Your<br />Business
        </h1>
        <h2 className="font-montserrat font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gold mb-4 tracking-tight leading-tight">
          Growing Your<br />Wealth
        </h2>
        <p className="font-lato text-white/95 text-sm sm:text-base max-w-xl mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link
            to="/contact"
            className="w-full sm:w-auto px-5 py-2 font-montserrat font-semibold text-sm rounded bg-gold text-navyblue shadow hover:bg-lightgold transition-colors hover-scale text-center"
          >
            Get Started
          </Link>
        </div>
