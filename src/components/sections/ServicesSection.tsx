...
const ServicesSection = () => {
  ...
  return <section className="py-20 bg-lightgray">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle title="What We Do For You as Chartered Accountants" subtitle="We run the businesses you own. Our services are paid for by the business, not by you directly." centered />
        
        <div className="mb-8 max-w-3xl mx-auto text-center">
          <p className="text-charcoal text-lg">As professionals, we're qualified to manage businesses properly. The businesses you own pay us to run them, not you. This way, you can focus on your life while we focus on growing your business.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <ServiceCard title={service.title} description={service.description} icon={service.icon} link={service.link} />
            </div>)}
        </div>
      </div>
    </section>;
